...
# Findings
The climate desk's archive on NPR.org includes <b>nearly 300 pieces published since October 2022</b>. 
...
* Native Americans are among several disadvantaged communities of people who are more vulnerable to climate change, and the small number of stories I found about this group suggests NPR is underreporting a community that's facing outsized effects of climate change. For example, I only found <a href="https://www.npr.org/2022/12/07/1140861347/un-biodiversity-convention-aims-to-slow-humanitys-war-with-nature-heres-whats-at-" target="_blank">two stories</a> mentioning <a href="https://www.npr.org/2022/12/06/1141047752/delegates-meet-with-a-mandate-to-set-global-biodiversity-goals-for-the-next-ten-" target="_blank">their displacement</a>.
...
" target="_blank">developing countries</a> at the United Nations Climate Change Conference in November, but ongoing coverage of the connection between poverty and climate change has been far more scarce.
* Few articles mentioned [sewer overflows](#sewer) and [methane flaring](#flaring), suggesting space to follow up on the pitches I mentioned in my cover letter.



![](outputs/Word pairs-over time.png){width=90%}

***

![](outputs/Word pairs-health.png){width=90%}

***

![](outputs/Word pairs-native.png){width=90%}

***

![](outputs/Word pairs-poverty.png){width=90%}
